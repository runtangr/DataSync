...
sql = """SELECT *
  FROM (
           SELECT TOP 500 a.SEQ Seq, a.MTIME Mtime,QKTZ20160429.dbo.Date2Str( a.MTIME ) AS II_Mtime, CASE x.TRADE_MKT_REF
                                                  WHEN 1 THEN 'SZ'
                                                  WHEN 2 THEN 'SH'
                                                  ELSE ''
                  ...
                  a.CHANGEDATE ChangeDate,QKTZ20160429.dbo.Date2Str( a.CHANGEDATE ) AS II_ChangeDate,
